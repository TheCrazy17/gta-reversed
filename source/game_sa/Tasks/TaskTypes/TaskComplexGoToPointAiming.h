...
public:
    ...
    CTask* Clone() const override { return new CTaskComplexGoToPointAiming(m_moveState, m_movePos, m_aimAtEntity, m_aimPos, m_moveTargetRadius, m_slowDownDistance); } // 0x66CD80
