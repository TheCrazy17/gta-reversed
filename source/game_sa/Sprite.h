...
public:
    ...
    static void RenderBufferedOneXLUSprite_Rotate_2Colours(float x, float y, float z, float w, float h, uint8 r1, uint8 g1, uint8 b1, uint8 r2, uint8 g2, uint8 b2, float dirX, float dirY, float recipNearZ, float rotation, uint8 a);
